      ...
      <div className="flex flex-col gap-6" dir={isRTL ? "rtl" : "ltr"}>
        <div className="flex flex-row flex-wrap gap-4">
          <SimpleInput
            ...
            type="text"
            {...register("first_name")}
            errors={errors?.first_name || realTimeErrors.first_name}
            onChange={(
          ...
          <SimpleInput
            ...
            type="text"
            {...register("last_name")}
            errors={errors?.last_name || realTimeErrors.last_name}
            onChange={(
              e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
            ) => {
        ...
        <SimpleInput
          ...
          type={"date"}
          errors={errors?.date_of_birth || realTimeErrors.date_of_birth}
        ...
        <DropDown
          ...
          {...register("wilaya")}
          errors={errors?.wilaya || realTimeErrors.wilaya}
          options={wilayas}
          searchable={true}
          onChange={(value) => {
            const selectedWilaya =
              wilayas.find((w) => w.id === value)?.text || "";
            handleFieldChange("wilaya", selectedWilaya);
          }}
        />
        <InputButton
          ...
          errors={errors?.phone_number || realTimeErrors.phone_number}
