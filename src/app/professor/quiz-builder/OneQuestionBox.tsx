...
export default function OneQuestionBox({ t, isRTL, question, questionNumber = 1 }: OneQuestionBoxProps) {
  ...
  // If no question prop provided, show nothing or placeholder
  if (!question) {
    return null;
  }
        ...
        <div className="flex flex-row justify-between items-center relative">
          ...
          <div className="flex flex-col gap-1">
            <div className="text-primary-400 text-2xl font-medium">
              {t("professor.quizes.Question")} {questionNumber}
            </div>
            <div className="text-neutral-400 font-normal text-sm">
              {t("professor.quizes.TotalPoints")}: {question.points || 0}
            </div>
          </div>
          {/* actions */}
          <div className="w-fit">
