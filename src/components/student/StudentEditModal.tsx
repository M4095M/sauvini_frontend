          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                {t("profile.editSubtitle") ?? "Edit the details about yourself"}
              </div>
            </div>
          ...
          <div className="flex flex-col gap-8">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-sm text-neutral-700 dark:text-neutral-300">
                      {avatarFile
                        ? avatarFile.name
                        : t("profile.dragOrBrowse") ??
                          "Drag your image or browse"}
                      <div className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">
                        {t("profile.maxSizeHint") ?? "Max 5 MB. JPG/PNG."}
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <input
                  aria-label={t("profile.wilaya") ?? "Wilaya"}
                  value={form.wilaya}
              ...
              <div>
                <label className="text-sm text-neutral-700 dark:text-neutral-300">
                  {t("profile.academicStream") ?? "Academic Stream"}
                </label>
                <input
                  aria-label={t("profile.academicStream") ?? "Academic Stream"}
                  value={form.academicStream}
                  onChange={handleChange("academicStream")}
                  className={`mt-2 ${inputClass}`}
                />
              </div>
              ...
              <div>
                ...
                <input
                  aria-label={t("profile.email") ?? "Email"}
                  value={form.email}
            ...
            <div className="w-full flex items-center justify-end gap-3 pt-4">
              ...
              <Button
                ...
                icon_position="none"
                size="S"
                text={t("profile.saveChanges") ?? "Save Changes"}
                onClick={handleSave}
                disabled={saving}
                optionalStyles="!px-6 !py-3"
              />
