...
export function useAuth() {
  ...
  const loginStudent = useCallback(
    ...
    ): Promise<LoginResponse<Student> | null> => {
      setLoading(true);
      setError(null);
      try {
        ...
        if (response) {
          ...
          AuthApi.setTokens(response.token);
          return response;
        } else {
  ...
  const loginProfessor = useCallback(
    async (
      credentials: LoginRequest
    ): Promise<LoginResponse<Professor> | null> => {
      setLoading(true);
      setError(null);
      try {
  ...
  const loginAdmin = useCallback(
    async (credentials: LoginRequest): Promise<LoginResponse<Admin> | null> => {
      setLoading(true);
      setError(null);
      try {
  ...
  const forgotPasswordAdmin = useCallback(
  ...
  const resetPasswordAdmin = useCallback(
    async (data: ResetPasswordConfirmRequest): Promise<boolean> => {
      setLoading(true);
      setError(null);
      try {
  ...
  const getAllProfessors = useCallback(
    async (pagination?: PaginationRequest): Promise<Professor[] | null> => {
      setLoading(true);
      setError(null);
      try {
