...
// Lowercase exports for compatibility
export { ModulesApi as modulesApi } from "./modules";
export { ChaptersApi as chaptersApi } from "./chapters";
...
export const API_CONSTANTS = {
  ...
  ENDPOINTS: {
    AUTH: {
      ...
      LOGOUT: "/auth/logout",
      REFRESH_STUDENT: "/auth/student/refresh-token",
      REFRESH_PROFESSOR: "/auth/professor/refresh-token",
      REFRESH_ADMIN: "/auth/admin/refresh-token",
