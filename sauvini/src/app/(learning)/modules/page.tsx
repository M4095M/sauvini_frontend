...
export default function ModulesPage() {
  ...
  const userProfile = user
    ? {
        ...MOCK_USER_PROFILE,
        id: user.id || MOCK_USER_PROFILE.id,
        name: (user as any)?.first_name || MOCK_USER_PROFILE.name,
        lastname: (user as any)?.last_name || MOCK_USER_PROFILE.lastname,
        email: (user as any)?.email || MOCK_USER_PROFILE.email,
        academicStream:
          (user as any)?.academic_stream || MOCK_USER_PROFILE.academicStream,
      }
    : MOCK_USER_PROFILE;
