...
export default function ProfessorLoginPage() {
  ...
  const { register, getValues, setErrors, errors } = useForm<LoginRequest>({} as any);
        ...
        >
              ...
              <form onSubmit={(e) => {
                ...
                <div className="space-y-2">
                  <p className={`text-sm text-gray-600 dark:text-gray-300 ${isRTL ? "font-arabic" : "font-sans"}`}>
                    ...
                    <Link href="/register" className="text-[var(--primary-300)] hover:opacity-90 font-medium">
                      {t("auth.login.signUp")}
                    </Link>
                  </p>
                  <p className={`text-xs text-gray-500 dark:text-gray-400 ${isRTL ? "font-arabic" : "font-sans"}`}>
                    {t("auth.login.wrongRole") || "Not a professor?"}{" "}
                    <Link href="/auth/login/student" className="text-[var(--primary-300)] hover:opacity-90 font-medium">
          ...
          >
            ...
            <div className="relative z-10 px-12 text-center">
              ...
              <h2 className={`text-3xl font-bold mb-4 text-white ${isRTL ? "font-arabic" : "font-sans"}`}>
                {t("auth.login.tagline") || "Where learning meets purpose"}
              </h2>
              <p className={`text-lg text-white/90 ${isRTL ? "font-arabic" : "font-sans"}`}>
                {t("auth.login.professorTagline") || "Empower students and shape the future of education"}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="lg:hidden min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="px-5 sm:px-6 py-6">
          ...
          <div className="flex justify-center mb-8">
            <Image src="/S_logo.svg" alt="Logo" width={60} height={60} className="block dark:hidden" />
            <Image src="/S_logo_white.svg" alt="Logo" width={60} height={60} className="hidden dark:block" />
          </div>
          ...
          {/* Welcome Text */}
          <div className={`${isRTL ? "text-right" : "text-left"} sm:text-center mb-10`}>
