...
export default function VerifyCodeAndResetPage() {
  ...
  const handleResetPassword = async (e?: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await AuthApi.resetPasswordProfessor(trimmedCode, newPassword);
      ...
      setTimeout(() => {
        router.push('/auth/login/professor?reset=success');
      }, 3000);
    } catch (error: any) {
          ...
          >
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <Link href="/auth/forgot-password/professor" className="block">
                  <Button
                    state="outlined"
                    size="M"
      ...
      <div className="lg:hidden min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
        <div className="px-5 sm:px-6 py-6">
          <div className="flex justify-between items-center mb-9">
            <Link href="/auth/forgot-password/professor">
